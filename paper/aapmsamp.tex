% ****** Start of file Pythia8_SBI_Tune.tex ******
%
...
%
%  1)  latex  Pythia8_SBI_Tune
%  2)  bibtex Pythia8_SBI_Tune
%  3)  latex  Pythia8_SBI_Tune
%  4)  latex  Pythia8_SBI_Tune
%
...
via a \verb+\bibliography+ command referencing the \verb+Pythia8_SBI_Tune.bib+ file.
Running Bib\TeX\ (in this case \texttt{bibtex
Pythia8_SBI_Tune}) after the first pass of \LaTeX\ produces the file
\verb+Pythia8_SBI_Tune.bbl+ which contains the automatically formatted
...
\nocite{*}
\bibliography{Pythia8_SBI_Tune}% Produces the bibliography via BibTeX.

\end{document}
%
% ****** End of file Pythia8_SBI_Tune.tex ******
